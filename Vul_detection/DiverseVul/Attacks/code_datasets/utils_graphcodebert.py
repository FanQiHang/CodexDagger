...
def convert_examples_to_features_adv(code, tokenizer, label, args):
    # source
    parser = parsers['c']
    func = code
...
class TextDataset_graphcodebert_bert(Dataset):
    def __init__(self, tokenizer, args, idxx, file_path='train'):
        self.examples = []
        self.args = args
