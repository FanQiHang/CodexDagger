...
def add_args(parser):
    ...
    parser.add_argument("--attack_model", default=None, type=str, help="Student Model")
    parser.add_argument("--victim_model", default=None, type=str, help="Teacher Model")
    parser.add_argument("--temperature", default=4, type=float, help="")
    parser.add_argument("--alpha", default=0.5, type=float, help="")
    parser.add_argument("--finetune_name", default='', type=str, help="")
