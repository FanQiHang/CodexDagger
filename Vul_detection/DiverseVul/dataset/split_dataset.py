...
filename = './process_data/diversevul.jsonl'

process_filename = './process_diversevul.json'

with open(process_filename, "w", encoding="utf-8") as file:
...
print(my_dict)
new_dict = {key: value for key, value in my_dict.items() if value > 30}
print(new_dict)
print(len(new_dict))
...
sample_test_0 = random.sample(ls_label_0, 948)
...
for key, value in new_dict.items():
    print(value)
    temp_sample_test_1 = random.sample(value, 5)
